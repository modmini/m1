...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EoXn5266R6d7f43scXMa.OCTUHf+O8MrV6kxfKrHb/G.o3egG04YHkxUdRtksN0/QhtSE5E+4xhpkg0HUJzpZSw=")
cl.loginResult()

#ki = LINETCR.LINE()
#ki.login(token="EowL3q6hDUfzVTvhtEY1.C+TdLVVLQdydLYvK6wIuiq./GGXBMVg9UytKtqbRASj5Y15JwUxb0VkRXJGJ2JkXDo=")
#ki.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token="Eoin8AjOfggTZ4FfTtte.PxAXNlSCMIA2nMcrtUErVG.VoTeGVzWj+5UEZeItpmctEmE9WrTZm8k7nfiOhgqO8E=")
#ki2.loginResult()

#ki3 = LINETCR.LINE()
#ki3.login(token="Eop81m6kBx5A44o81Zi8.2k5RU+pBtUFei2dSstwBEa.Ij3KVEw6gSHeyYImBs22/V0PQQoTGku9yg3zFENo/JA=")
#ki3.loginResult()

#ki4 = LINETCR.LINE()
#ki4.login(token="EoDwbg5UgzwepeylKRDc.3nkuNiO4VRwNsW011Xda7a.+/5ID5kX1S6GvHO+BGPAgEmYYL7QioGwo6z5UceoS1U=")
#ki4.loginResult()

#ki5 = LINETCR.LINE()
#ki5.login(token="EoEg4quzilw08naoQNB4.wYJrjn8mz5Ran8sdCRC21a.Xh5WJr6KxYUTwyFeFdqS6kCWQEh/PzUff4ng5wGkVOk=")
#ki5.loginResult()
